...
/**
 * Helper class for the Book Index exercise.
 * 
 * Note: This class is not supposed to demonstrate best practices :-)
 */
public class BookReader {

	public static final int WORDS_PER_PAGE = 100;
	...
	private void readBook() {
		...
		int pageCount = wordCount / WORDS_PER_PAGE + 1;
		...
		for (int p=0; p<pageCount; p++) {
			...
			List<String> wordsOnPage = new ArrayList<>();
			pages.add(wordsOnPage);
			
			for (int w=0; w<WORDS_PER_PAGE && counter < wordCount; w++) {
				wordsOnPage.add(words[counter]);
				counter++;
			}
		}
	}
	...
	public List<String> getWordsOnPage(int pageNumber) {
	...
	private String text = 
		...
		"in it. Let the most absent-minded of men be plunged in his deepes " +
